...
async def start(bot, message):
  await message.reply_photo("https://telegra.ph/file/59d60f82a949be24bce78.jpg",caption=START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"), InlineKeyboardButton(text="join channel", url="https://t.me/axlshopping_store")]]))

@app.on_message(filters.command("help"))
async def help(bot, message):
  await message.reply_photo("https:// https://telegra.ph/file/59d60f82a949be24bce78.jpg",caption=HELP,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Back", callback_data="start_menu")]]))

@app.on_message(filters.command("logo") & filters.incoming & filters.text & ~filters.forwarded & (
  filters.group | filters.private))
async def logo(bot, message):
  try:
    text = message.text.replace("logo","").replace("/","").replace("@Axlautomaker_00bot","").strip().upper()
...
async def start_menu(_,query):
  await query.answer()
  await query.message.edit(START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"),InlineKeyboardButton(text="join channel", url="https://t.me/axlshopping_store")]]))
...
async def logo_doc(_,query):
  ...
  try:
    ...
    await query.message.reply_document(link,caption="**🖼 Logo Generated By @Axlautomaker_00bot**")
  except FloodWait:
    pass
  except Exception as e:
    try:
      return await x.edit(f"`❌ Something Went Wrong...`\n\nReport This Error In @ultrafix_chatgroup \n\n`{str(e)}`")
    except:
      return
